...
- **Python version**: `>=3.14.7` (`pyproject.toml`), ruff `target-version = "py314"`. This is newer than most Home Assistant core/integration code, so older-Python idioms and fallbacks are usually unnecessary.
